        ...
        <div class="postbox">
            ...
            <div class="inside">
                ...
                if ( $uploadFile ) {
                    ...
                    <form action="<?php echo esc_attr( admin_url( 'options-general.php?page=wpdash_child_tabb&tab=restore-clone&upload=yes' ) ); ?>" method="post" enctype="multipart/form-data">
                        <input type="file" name="file" id="file" />
